    ...
    <div class="container py-4">
      <header class="pb-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
          <svg xmlns="http://checklist.tianguiztli.com/img/logo1.png" width="40" height="32" class="me-2" viewBox="0 0 118 94" role="img">
          ...
          <span class="fs-4">Comercializadora Tianguiztli</span>
        </a>
      </header>
