...
if($fechaInicial==$fechaFinal){
    $sql="SELECT b.nombre,a.fecha_pago,a.fecha_inicial,a.fecha_final,SUM(a.dias_pagados) AS dias_pagados, SUM(total) AS total FROM historial_pagos_cocina a INNER JOIN lista_servicio_cocina b ON a.id_usuario=b.id_usuario  WHERE fecha_pago LIKE '$fechaInicial%' GROUP BY a.fecha_pago  ORDER BY id_historial";
